...
function liftColor(color2) {
  if (isString(color2)) {
    ...
    ret.colorStops = map(color2.colorStops, function(stop2) {
      return {
        offset: stop2.offset,
...
function buildPath2(ctx, shape) {
  ...
  var arc2 = mathAbs2(endAngle - startAngle);
  var mod = arc2 > PI26 && arc2 % PI26;
  mod > e && (arc2 = mod);
  if (!(radius > e)) {
    ctx.moveTo(cx, cy);
  } else if (arc2 > PI26 - e) {
...
function createCanvasPattern(ctx, pattern, el) {
  ...
  if (isImageReady(image)) {
    ...
    if (typeof DOMMatrix === "function" && canvasPattern && canvasPattern.setTransform) {
      var matrix5 = new DOMMatrix();
      matrix5.translateSelf(pattern.x || 0, pattern.y || 0);
      matrix5.rotateSelf(0, 0, (pattern.rotation || 0) * RADIAN_TO_DEGREE);
      matrix5.scaleSelf(pattern.scaleX || 1, pattern.scaleY || 1);
      canvasPattern.setTransform(matrix5);
    }
...
***************************************************************************** */
//# sourceMappingURL=chunk-K6DEBBKI.js.map
