...
extendChartView({
  ...
  render: function(seriesModel, ecModel, api) {
    ...
    if (showOutline) {
      ...
      outlineBorderWidth = parsePercent2(seriesModel.get("outline.itemStyle.borderWidth"), size);
    }
    ...
    function getPath(r, isForClipping) {
      if (symbol) {
        if (isPathSymbol(symbol)) {
          ...
          path = graphic_exports.makePath(symbol.slice(7), {}, new graphic_exports.BoundingRect(left2, top2, w, h));
          if (isForClipping) {
            path.x = -w / 2;
            path.y = -h / 2;
          }
          ...
          return helper_exports.createSymbol("rect", x, y, r[0] * 2, r[1] * 2);
        } else {
    ...
    function getWave(idx, isInverse, oldWave) {
      ...
      var amplitude = parsePercent2(itemModel2.get("amplitude"), radiusY * 2);
      var waveLength = parsePercent2(itemModel2.get("waveLength"), radiusX * 2);
